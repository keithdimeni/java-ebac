...
public class TestePerformanceSet {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            hashSet.add(new Aluno("João da Silva", "Linux básico", (double) x));
        }
        // end time
        ...
        for (int i = 0; i < 1000; i++) {
            int x = r.nextInt(1000 - 10) + 10;
            treeSet.add(new Aluno("João da Silva", "Linux básico", (double) x));
        }
        // end time
        ...
        for (int i = 0; i < 1000; i++) {
            int x = r.nextInt(1000 - 10) + 10;
            linkedSet.add(new Aluno("João da Silva", "Linux básico", (double) x));
        }
        // end time
        endTime = System.currentTimeMillis();
        duration = endTime - startTime;
