...
public class Pessoa {
    ...
    public List popularPessoas() {
        Pessoa pessoa1 = new Pessoa("p1", "Gustavo Dimeni", "Angola", 27);
        Pessoa pessoa2 = new Pessoa("p2", "Felicidade Dimeni", "Mexico", 25);
        Pessoa pessoa3 = new Pessoa("p3", "Mauro Dimeni", "Estados Unidos da America", 29);
        Pessoa pessoa4 = new Pessoa("p4", "Ludmila Dimeni", "India", 30);
        Pessoa pessoa5 = new Pessoa("p5", "Vanesa Dimeni", "Angola", 29);
